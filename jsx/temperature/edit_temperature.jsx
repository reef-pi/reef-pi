...
const EditTemperature = ({values, errors, touched, sensors, equipment, submitForm, isValid, dirty, readOnly, showChart}) => {
  const handleSubmit = (event) => {
    ...
    if (dirty === false || isValid === true) {
      ...
      showAlert('The temperature settings cannot be saved due to validation errors.  Please correct the errors and try again.')
    }
  }
    ...
    <form onSubmit={handleSubmit}>
      <div>
        ...
        <div className='row'>
          ...
          <div className='col-12 col-sm-6 col-md-3'>
            <div className='form-group'>
              ...
              <Field name='sensor' component='select' disabled={readOnly}
                className={classNames('custom-select', {'is-invalid': ShowError('sensor', touched, errors)})}>
          ...
          <div className = 'col-12 col-sm-6 col-md-3'>
            <div className='form-group'>
              ...
              <Field name='fahrenheit' component={BooleanSelect} disabled={readOnly}
                className={classNames('custom-select', {'is-invalid': ShowError('fahrenheit', touched, errors)})}>
            ...
            <div className='form-group'>
              ...
              <div className='input-group'>
                ...
                <div className='input-group-append'>
                  ...
                  <span className='input-group-text d-flex d-lg-none'>
                    sec
                  </span>
                </div>
          ...
          <div className = 'col-12 col-sm-6 col-md-3'>
            <div className='form-group'>
              ...
              <Field name='enabled' component={BooleanSelect} disabled={readOnly}
                className={classNames('custom-select', {'is-invalid': ShowError('enabled', touched, errors)})}>
          ...
          <div className = 'col-12 col-sm-6 col-md-3'>
            <div className='form-group'>
              ...
              <Field name='alerts' component={BooleanSelect} disabled={readOnly}
                className={classNames('custom-select', {'is-invalid': ShowError('alerts', touched, errors)})}>
                <option value='true'>Enabled</option>
                <option value='false'>Disabled</option>
              </Field>
        ...
        <div className='row'>
          ...
          <div className={classNames('col-12 col-sm-6 col-md-3 d-sm-block', {'d-none': values.heater === ''})}>
            <div className='form-group'>
          ...
          <div className='col-12 col-sm-6 col-md-3'>
            <div className='form-group'>
              ...
              <Field name='cooler' component='select' disabled={readOnly}
                className={classNames('custom-select', {'is-invalid': ShowError('cooler', touched, errors)})}>
                <option key='' value=''>None</option>
                {equipmentOptions()}
              </Field>
          ...
          <div className={classNames('col-12 col-sm-6 col-md-3 d-sm-block', {'d-none': values.cooler === ''})} >
            <div className='form-group'>
