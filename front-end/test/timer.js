module.exports = {
  Create: function (n) {
    n.click('a#tab-timers')
      ...
      .select('.add-timer [name="equipment_id"]', '4')
      .select('.add-timer [name="revert"]', 'true')
      .wait('.add-timer [name="duration"]')
      .type('.add-timer [name="duration"]', '')
      .type('.add-timer [name="duration"]', 60 * 60 * 8)
