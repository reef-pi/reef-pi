...
export default class DiurnalChart extends React.Component {
  render(){
    ...
    let dEnd = new Date('1970-01-02T'+ ch.profile.config.end)
    ...
    for(i =0; i<100; i++) {
      ...
      let percent =  (i * step * 2 *Math.PI)/totalSeconds
      let k  = Math.pow(Math.cos(percent), 3)
