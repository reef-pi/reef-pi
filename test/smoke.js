...
function SmokeTest () {
  nightmare
    ...
    .click('input#add_tc')
    .wait(500)
    .type('input#new_tc_name', 'Jaeger100W')
    .wait(500)
    .click('input#new_tc_enable')
    .wait(500)
    ...
    .click('button#db-0-1')
    .wait(500)
    .click('span#ato-chart-0-1')
    .wait(500)
    .click('span#component-ato-0-1-1')
    .wait(500)
    .click('button#db-1-0')
    .wait(500)
    .click('span#light-chart-1-0')
    .wait(500)
    .click('span#component-light-1-0-1')
    .wait(500)
